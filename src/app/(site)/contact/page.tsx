    ...
    <>
      ...
      <section className="bg-brand-black py-20 lg:py-28">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          {/* Quote CTA Banner */}
          <div className="mb-16 border border-brand-accent/20 bg-brand-accent/3 p-8 lg:p-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
            ...
            <Link
              href="/quote"
              className="group inline-flex items-center gap-3 shrink-0 bg-brand-accent px-8 py-3.5 font-display text-sm font-bold uppercase tracking-widest text-brand-black transition-all duration-300 hover:shadow-[0_0_60px_rgba(212,255,0,0.18)]"
            >
              Get a Quote
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-24">
            ...
            <div className="flex flex-col gap-10 lg:pt-2">
              <a
                ...
                className="group flex items-center gap-5 border border-brand-grey-700 p-6 transition-all duration-300 hover:border-brand-accent hover:bg-brand-accent/3"
              >
                <div className="flex h-12 w-12 shrink-0 items-center justify-center bg-[#25D366]/10 transition-colors duration-300 group-hover:bg-[#25D366]/20">
              ...
              >
                <div className="flex h-12 w-12 shrink-0 items-center justify-center bg-brand-grey-900/50">
              ...
              <div className="space-y-6 pt-2">
                <div className="flex items-start gap-4">
                  <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-brand-accent" strokeWidth={1.5} />
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <Clock className="mt-0.5 h-4 w-4 shrink-0 text-brand-accent" strokeWidth={1.5} />
                  <div>
